        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center">Crear Catalogo</h3>
                        ...
                        <form action="/catalogo" method="POST">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="categoriaCatalogo" name="categoriaCatalogo" type="text" class="form-control" tabindex="1" maxlength="20">
                                </div>
                                ...
                                <a href="/catalogo" class="btn btn-secondary" tabindex="5">Cancelar</a>
