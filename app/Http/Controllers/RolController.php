...
class RolController extends Controller
{
    ...
    {
        $this->middleware('permission:ver-roles|crear-roles|editar-roles|borrar-roles');
    ...
    public function edit($id)
    {
        ...
        $rolePermissions = DB::table('role_has_permissions')->where('role_has_permissions.role_id', $id)
            ->pluck('role_has_permissions.permission_id', 'role_has_permissions.permiossion_id')
            ->all();
